...
<section id="main-content">
  ...
  <h3><i class="fa fa-angle-right"></i> Daftar Dokumen Keluar</h3>
    <div class="row mt">
        <div class="col-md-12">
...
<!--                       <td class="<?=$list->expstatus;?>">
    ...
    default:
        ...
        break;
                      ...
                      <td>
                        <a href="?url=operator/dokumen2/view/<?php echo $list->iddoc; ?>" class="btn btn-success btn-xs"><i class="fa fa-expand"></i> Lihat</a>
                         <a href="?url=operator/dokumen2/arsip/<?php echo $list->iddoc; ?>" class="btn btn-success btn-xs"><i class="fa fa-file"></i> Arsip</a>
                         <a href="?url=operator/dokumen2/tolak/<?php echo $list->iddoc; ?>" class="btn btn-danger btn-xs"><i class="fa fa-ban"></i> Tolak</a>
                      </td>
                    </tr>
                    <?php }?>
                ...
                <footer class="site-footer">
                    ...
                    <div class="col-md-6 col-xs-12 text-center">
                      ...
                      <a href="?url=operator/dokumen2/masuk" class="btn btn-sm btn-success" data-toggle="modal"><i class="fa fa-plus"></i> Daftar Dokumen Keluar</a>
                      <a href="?url=operator/dokumen2/masuk_arsip" class="btn btn-sm btn-success" data-toggle="modal"><i class="fa fa-plus"></i> Daftar Arsip</a>
