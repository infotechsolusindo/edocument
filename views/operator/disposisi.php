...
<section id="main-content">
  <section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> Disposisi</h3>
    <div class="row mt">
      <div class="col-md-12">
    ...
    ?>
          ...
          <footer class="site-footer">
            ...
            <div class="col-md-6 col-xs-12 text-center">
              ...
              <a href="?url=operator/dokumen/disposisi" class="btn btn-sm btn-danger" ><i class="fa fa-file"></i> Disposisi Baru</a>
              <a href="?url=operator/dokumen/disposisi_arsip" class="btn btn-sm btn-warning" ><i class="fa fa-file"></i> Arsip Disposisi</a>
          </footer>
        </div>
        <!-- /content-panel -->
      </div>
